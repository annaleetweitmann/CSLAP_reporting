...
## `r laketemp[1,2]` -- `r report_year[1]` Sampling Season Results
...
# report_year <- as.numeric("2018")
# lake1 <- lake
# lake1$year <- as.numeric(lake1$year)
...
#for (i in 1:(nrow(z_score_df))) {
    ...
    #z_score_df$diff[i] <- "C:/Users/amtweitm/OneDrive - New York State Office of Information Technology Services/Documents/R/CSLAP_reporting/images/blank.png"
  #}
  #else if(z_score_df$z_score[i] < 1 & z_score_df$z_score[i] > -1){
   # z_score_df$diff[i] <- "C:/Users/amtweitm/OneDrive - New York State Office of Information Technology #Services/Documents/R/CSLAP_reporting/images/no.png"
  #}
 # else if(z_score_df$z_score[i] >= 1 & z_score_df$z_score[i] < 2){
   # z_score_df$diff[i] <- "C:/Users/amtweitm/OneDrive - New York State Office of Information Technology Services/Documents/R/CSLAP_reporting/images/one_up_arrow.png"
 # }
#  else if(z_score_df$z_score[i] >= 2){
   # z_score_df$diff[i] <- "C:/Users/amtweitm/OneDrive - New York State Office of Information Technology Services/Documents/R/CSLAP_reporting/images/two_up_arrow.png"
 # }
 # else if(z_score_df$z_score[i] <= -1 & z_score_df$z_score[i] > -2){
 #   z_score_df$diff[i] <- "C:/Users/amtweitm/OneDrive - New York State Office of Information Technology Services/Documents/R/CSLAP_reporting/images/one_down_arrow.png"
#  }
#  else if(z_score_df$z_score[i] >= -2){
#    z_score_df$diff[i] <- "C:/Users/amtweitm/OneDrive - New York State Office of Information Technology Services/Documents/R/CSLAP_reporting/images/two_down_arrow.png"
#  }
#}
    ...
    for(j in 1:length(list_of_dates)){
      if(is.na(owi_withplots[i,j+1])){}
        ...
        make_table <- make_table %>%
          tab_style(style = cell_fill(color = "red", alpha = 0.8),
